...
const TestimoniosClientes = () => {
    return (
            <section className="contenedoropiniones" >
                <section className="tituloopiniones my-5">
                ...
                <div id="carouselExampleCaptions" class="carousel slide contenedorCliente" data-bs-ride="false">
